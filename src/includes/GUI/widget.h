	...
	namespace GUI{
		...
		class Widget: public Drivers::KeyboardEventHandler{
			...
			public:
				...
				virtual void OnMouseButtonDown(Types::int32_t X, Types::int32_t Y, Types::uint8_t Button);
				virtual void OnMouseButtonUp(Types::int32_t X, Types::int32_t Y, Types::uint8_t Button);
